...
class LogicalMatcherTransformerTest extends UnitTestSuite {
  ...
  test("transform() for a Term.ApplyInfix with 'super.not', when nested transformer returns a result - should return it wrapped by 'not'") {
    val matcher = q"super.not myMatcher(3)"
    val nestedMatcher = q"myMatcher(3)"
    val expectedNestedHamcrestMatcher = q"myHamcrestMatcher(3)"
    val expectedHamcrestMatcher = q"org.hamcrest.Matchers.not(myHamcrestMatcher(3))"
  ...
  test("transform() for a Term.ApplyInfix with 'super.not', when nested transformer returns None - should return None") {
    val matcher = q"super.not bla(3)"
  ...
  test("transform() for a Term.ApplyInfix with 'and', when LHS and RHS both transformed, should return 'allOf' of the results") {
    ...
    val expectedHamcrestMatcher = q"org.hamcrest.Matchers.allOf(hamcrestLeftIs(2), hamcrestRightIs(3))"
  ...
  test("transform() for a Term.ApplyInfix with 'or', when LHS and RHS both transformed, should return 'allOf' of the results") {
    ...
    val expectedLeftHamcrestMatcher = q"hamcrestLeftIs(2)"
    val expectedRightHamcrestMatcher = q"hamcrestRightIs(3)"
    val expectedHamcrestMatcher = q"org.hamcrest.Matchers.anyOf(hamcrestLeftIs(2), hamcrestRightIs(3))"
  ...
  test("transform() for a Term.Apply with 'super.not' when nested transformer returns a result - should return it wrapped by 'not'") {
    val matcher = q"super.not(myMatcher(3))"
    val nestedMatcher = q"myMatcher(3)"
    val expectedNestedHamcrestMatcher = q"myHamcrestMatcher(3)"
    val expectedHamcrestMatcher = q"org.hamcrest.Matchers.not(myHamcrestMatcher(3))"
  ...
  test("transform() for a Term.Apply with 'super.not' when nested matcher is not transformed, should return None") {
    val matcher = q"super.not(myMatcher(3))"
    val nestedMatcher = q"myMatcher(3)"
